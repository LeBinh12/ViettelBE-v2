...
namespace Domain.Entities
{
    ...
    public class Customer
    {
        ...
        [MaxLength(255, ErrorMessage = "⚠️ Họ tên không được vượt quá 255 ký tự.")]
        public string FullName { get; set; }

        [Required(ErrorMessage = "⚠️ Email không được để trống.")]
        ...
        [MaxLength(10, ErrorMessage = "⚠️ Số điện thoại không được vượt quá 10 ký tự.")]
